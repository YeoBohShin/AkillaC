...
# ""
  ...
  def create_thread():
    ...
    new_doc = Post(author, authorID, thread_content, combined_string, timestamp, parentID, [], [])
  ...
  def reply_to_thread():
    ...
    new_doc = Post(author, authorID, reply_content, combined_string, timestamp, parent_id, [], [])
